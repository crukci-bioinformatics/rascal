...
ui <- fluidPage(
  ...
  # tags$div(style = "font-size:75%; float:right;", "Cancer Research UK Cambridge Institute's cookie policy can be found", tags$a(href = "https://content.cruk.cam.ac.uk/computing/cruk-domains.html", "here."), p()),
  br()
)
